...
Item.create(name: "skis", year: 2005, company: "dps", hobbie_id: hobby1.id)
Item.create(name: "boots", year: 2005, company: "dynafit", hobbie_id: hobby1.id)
Item.create(name: "poles", year: 2005, company: "marker", hobbie_id: hobby1.id)

Item.create(name: "pole", year: 2005, company: "ugly_stick", hobbie_id: hobby2.id)
Item.create(name: "lure", year: 2005, company: "rapala", hobbie_id: hobby2.id)
